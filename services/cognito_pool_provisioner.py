...
def sanitize_for_cognito_tags(value: str) -> str:
    """
    ONBOARD-003: Sanitize string for AWS Cognito tags.
    ...
    return sanitized.strip()[:256]  # AWS tag value max 256 chars
    ...
    async def create_organization_pool(
        ...
        try:
            ...
            pool_response = self.cognito_client.create_user_pool(
                ...
                # ONBOARD-037: Use tenant-specific login URL
                AdminCreateUserConfig={
                    'AllowAdminCreateUserOnly': True,
                    'InviteMessageTemplate': {
                        'EmailSubject': 'Welcome to Ascend - Your Login Credentials',
                        'EmailMessage': f'''Hello {{username}},

Welcome to Ascend by OW-KAI!

Your temporary password is: {{####}}

Please login at: https://pilot.owkai.app/org/{organization_slug}/login
...
''',
                ...
                UserPoolTags={
                    ...
                    'Organization': sanitize_for_cognito_tags(organization_slug),
                    'OrganizationId': str(organization_id),
                    'OrganizationName': sanitize_for_cognito_tags(organization_name),
