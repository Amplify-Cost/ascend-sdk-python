...
description: Enterprise analytics and reporting features in Ascend
---
...
**Source**: `/ow-ai-backend/routes/analytics_routes.py` (1,300+ lines)

| Endpoint | Method | Description | Line |
|----------|--------|-------------|------|
| `/api/analytics/trends` | GET | Alert trends analysis | 36 |
| `/api/analytics/realtime/metrics` | GET | Real-time metrics | 209 |
| `/api/analytics/predictive/trends` | GET | Predictive trends | 382 |
| `/api/analytics/executive/dashboard` | GET | Executive dashboard | 541 |
| `/api/analytics/performance` | GET | Performance analytics | 956 |
| `/api/analytics/performance/system` | GET | System performance | 957 |
| `WebSocket /api/analytics/ws/realtime/{user_email}` | WS | Real-time streaming | 1197 |
