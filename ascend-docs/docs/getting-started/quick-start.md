...
sidebar_position: 1
title: Quick Start
description: Get started with OW-AI Authorization Center in 5 minutes
---
...
:::info No Package Installation Required
...
class OWKAIClient:
    ...
    def submit_action(self, agent_id: str, action_type: str, description: str,
        ...
        Source: /ow-ai-backend/routes/actions_v1_routes.py:233
        """
        payload = {
            "agent_id": agent_id,
    ...
    def get_action_status(self, action_id: int) -> Dict:
        ...
        Source: /ow-ai-backend/routes/actions_v1_routes.py:794
        """
