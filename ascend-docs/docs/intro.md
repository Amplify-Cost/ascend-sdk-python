...
<div className="row">
  <div className="col col--6">
    <div className="card margin-bottom--lg">
      ...
      <div className="card__body">
        <p>Complete REST API with 564 endpoints.</p>
      </div>
      <div className="card__footer">
...
*Source: [cvss_auto_mapper.py](https://github.com/your-org/ow-ai-backend/blob/main/services/cvss_auto_mapper.py) lines 37-600*
