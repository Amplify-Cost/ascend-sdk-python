...
async def get_threat_intelligence_from_siem(
    ...
    try:
        ...
        if not siem_manager.active_connector:
            # SEC-089: Return honest "not configured" state instead of fake demo data
            return {
                ...
                "message": "SIEM integration not configured. Configure Splunk or Wiz.io to enable threat intelligence."
            }
...
async def query_siem_events(
    ...
    try:
        ...
        if not siem_manager.active_connector:
            # SEC-089: Return honest "not configured" state instead of fake demo events
            return {
                "status": "not_configured",
                "query": query,
                ...
                "events": [],
                "total_events": 0,
                "message": "SIEM integration not configured. Configure Splunk or Wiz.io to query security events."
            }
