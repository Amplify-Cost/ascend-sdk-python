...
# Find the line after "Enterprise assessment complete" log (around line 1400)
...
# The orchestration code to insert
orchestration_code = '''
            ...
            try:
                ...
                for workflow in active_workflows:
                    ...
                    # Simple matching: if action_type in trigger conditions or workflow is for all actions
                    should_trigger = (
                ...
                logger.warning(f"⚠️ Enterprise orchestration failed for action {action_id}: {str(orchestration_error)}")
                # Don't fail the submission if orchestration fails
            # === END ORCHESTRATION ===
            
'''

# Insert the orchestration code
...
print(f"✅ Orchestration code inserted at line {insert_position}")
print("📍 Location: After enterprise assessment, before return statement")
