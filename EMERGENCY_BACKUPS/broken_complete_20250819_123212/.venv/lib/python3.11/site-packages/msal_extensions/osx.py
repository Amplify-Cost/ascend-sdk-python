...
_SECURITY_KEYCHAIN_FIND_GENERIC_REDACTED-CREDENTIAL = _SECURITY.SecKeychainFindGenericPassword
_SECURITY_KEYCHAIN_FIND_GENERIC_REDACTED-CREDENTIAL.argtypes = (
    _ctypes.c_void_p,
    _ctypes.c_uint32,
    _ctypes.c_char_p,
    _ctypes.c_uint32,
...
_SECURITY_KEYCHAIN_FIND_GENERIC_REDACTED-CREDENTIAL.restype = OS_RESULT
...
_SECURITY_KEYCHAIN_ADD_GENERIC_REDACTED-CREDENTIAL = _SECURITY.SecKeychainAddGenericPassword
_SECURITY_KEYCHAIN_ADD_GENERIC_REDACTED-CREDENTIAL.argtypes = (
    _ctypes.c_void_p,
    _ctypes.c_uint32,
    _ctypes.c_char_p,
    _ctypes.c_uint32,
...
_SECURITY_KEYCHAIN_ADD_GENERIC_REDACTED-CREDENTIAL.restype = OS_RESULT
...
class Keychain(object):
    ...
    def get_generic_password(self, service, account_name):
        ...
        exit_status = _SECURITY_KEYCHAIN_FIND_GENERIC_REDACTED-CREDENTIAL(
            self._ref,
            len(service),
            service,
            len(account_name),
    ...
    def set_generic_password(self, service, account_name, value):
        ...
        find_exit_status = _SECURITY_KEYCHAIN_FIND_GENERIC_REDACTED-CREDENTIAL(
            self._ref,
            len(service),
            service,
            len(account_name),
        ...
        if not find_exit_status:
            ...
            add_exit_status = _SECURITY_KEYCHAIN_ADD_GENERIC_REDACTED-CREDENTIAL(
                self._ref,
                len(service),
                service,
                len(account_name),
