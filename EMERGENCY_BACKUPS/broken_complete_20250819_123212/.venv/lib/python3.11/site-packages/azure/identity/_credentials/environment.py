...
class EnvironmentCredential:
    ...
    Service principal with certificate:
      ...
      - **AZURE_CLIENT_CERTIFICATE_REDACTED-CREDENTIAL**: (optional) password of the certificate file, if any.
      - **AZURE_AUTHORITY_HOST**: authority of a Microsoft Entra endpoint, for example
        "login.microsoftonline.com", the authority for Azure Public Cloud, which is the default
        when no value is given.
    ...
    User with username and password:
      ...
      - **AZURE_REDACTED-CREDENTIAL**: that user's password
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        if all(os.environ.get(v) is not None for v in EnvironmentVariables.CLIENT_SECRET_VARS):
            ...
            self._credential = CertificateCredential(
                ...
                password=os.environ.get(EnvironmentVariables.AZURE_CLIENT_CERTIFICATE_REDACTED-CREDENTIAL),
                **kwargs
            )
        elif all(os.environ.get(v) is not None for v in EnvironmentVariables.USERNAME_REDACTED-CREDENTIAL_VARS):
            self._credential = UsernamePasswordCredential(
                client_id=os.environ[EnvironmentVariables.AZURE_CLIENT_ID],
                username=os.environ[EnvironmentVariables.AZURE_USERNAME],
                password=os.environ[EnvironmentVariables.AZURE_REDACTED-CREDENTIAL],
        ...
        if self._credential:
            ...
            expected_variables = set(
                ...
                + EnvironmentVariables.USERNAME_REDACTED-CREDENTIAL_VARS
            )
