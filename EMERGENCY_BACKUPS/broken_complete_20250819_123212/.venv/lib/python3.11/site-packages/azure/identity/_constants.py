...
class EnvironmentVariables:
    ...
    AZURE_CLIENT_CERTIFICATE_REDACTED-CREDENTIAL = "AZURE_CLIENT_CERTIFICATE_REDACTED-CREDENTIAL"
    CERT_VARS = (AZURE_CLIENT_ID, AZURE_CLIENT_CERTIFICATE_PATH, AZURE_TENANT_ID)

    AZURE_USERNAME = "AZURE_USERNAME"
    AZURE_REDACTED-CREDENTIAL = "AZURE_REDACTED-CREDENTIAL"
    USERNAME_REDACTED-CREDENTIAL_VARS = (AZURE_CLIENT_ID, AZURE_USERNAME, AZURE_REDACTED-CREDENTIAL)
