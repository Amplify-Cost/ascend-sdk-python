...
class HandlerCase(TestCase):
    ...
    def test_63_large_secret(self):
        """test MAX_REDACTED-CREDENTIAL_SIZE is enforced"""
        from passlib.exc import PasswordSizeError
        from passlib.utils import MAX_REDACTED-CREDENTIAL_SIZE
        secret = '.' * (1+MAX_REDACTED-CREDENTIAL_SIZE)
        hash = self.get_sample_hash()[1]
        err = self.assertRaises(PasswordSizeError, self.do_genhash, secret, hash)
        self.assertEqual(err.max_size, MAX_REDACTED-CREDENTIAL_SIZE)
