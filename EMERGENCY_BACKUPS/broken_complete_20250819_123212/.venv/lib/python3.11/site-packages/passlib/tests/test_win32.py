...
class UtilTest(TestCase):
    ...
    def test_lmhash(self):
        ...
        for secret, hash in [
            ("OLDREDACTED-CREDENTIAL", u("c9b81d939d6fd80cd408e6b105741864")),
            ("NEWREDACTED-CREDENTIAL", u('09eeab5aa415d6e4d408e6b105741864')),
    ...
    def test_nthash(self):
        ...
        for secret, hash in [
            ("OLDREDACTED-CREDENTIAL", u("6677b2c394311355b54f25eec5bfacf5")),
            ("NEWREDACTED-CREDENTIAL", u("256781a62031289d3c2c98c14f1efc8c")),
            ]:
