...
MySQL 3.2.3 / OLD_REDACTED-CREDENTIAL()

    This implements Mysql's OLD_REDACTED-CREDENTIAL algorithm, introduced in version 3.2.3, deprecated in version 4.1.
...
MySQL 4.1.1 / NEW REDACTED-CREDENTIAL
    This implements Mysql new REDACTED-CREDENTIAL algorithm, introduced in version 4.1.
