...
from passlib.utils import (
    ...
    MAX_REDACTED-CREDENTIAL_SIZE, accepts_keyword, as_bool,
...
def validate_secret(secret):
    ...
    if len(secret) > MAX_REDACTED-CREDENTIAL_SIZE:
        raise exc.PasswordSizeError(MAX_REDACTED-CREDENTIAL_SIZE)
