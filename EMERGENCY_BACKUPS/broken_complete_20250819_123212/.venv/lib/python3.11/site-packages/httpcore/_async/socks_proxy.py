...
AUTH_METHODS = {
    ...
    b"\x01": "GSSAPI",
    b"\x02": "USERNAME/REDACTED-CREDENTIAL",
...
async def _init_socks5_connection(
    ...
    *,
    ...
    auth_method = (
        ...
        if auth is None
        else socksio.socks5.SOCKS5AuthMethod.USERNAME_REDACTED-CREDENTIAL
    )
    ...
    if response.method == socksio.socks5.SOCKS5AuthMethod.USERNAME_REDACTED-CREDENTIAL:
