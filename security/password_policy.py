...
# =============================================================================
# ENTERPRISE BANKING-LEVEL PASSWORD POLICY
# =============================================================================
...
class PasswordPolicyConfig:
    ...
    min_length: int = int(os.getenv("PASSWORD_MIN_LENGTH", "12"))
    max_length: int = int(os.getenv("PASSWORD_MAX_LENGTH", "128"))
    ...
    require_numbers: bool = os.getenv("PASSWORD_REQUIRE_NUMBERS", "true").lower() == "true"
    require_special: bool = os.getenv("PASSWORD_REQUIRE_SPECIAL", "true").lower() == "true"
    min_unique_chars: int = int(os.getenv("PASSWORD_MIN_UNIQUE_CHARS", "8"))
    max_consecutive_chars: int = int(os.getenv("PASSWORD_MAX_CONSECUTIVE_CHARS", "3"))

    # Common password blacklist
    check_common_passwords: bool = True

    # Password history (prevent reuse)
    password_history_count: int = int(os.getenv("PASSWORD_HISTORY_COUNT", "12"))
