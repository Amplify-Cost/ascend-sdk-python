                ...
                >
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-2 flex-wrap gap-2">
                          ...
                          {activity.policy_evaluated && (
                            <PolicyDecisionBadge decision={activity.policy_decision} />
                          )}
                  ...
                  {isExpanded && (
                    <div className="p-4 bg-gray-50 space-y-4">
                      {/* Risk Fusion Analysis Card - Option 4 */}
                      {activity.policy_evaluated && (
                        <div className="bg-white border border-gray-200 rounded-lg p-4">
                          <PolicyFusionDisplay
                            policyEvaluated={activity.policy_evaluated}
                            policyDecision={activity.policy_decision}
                            policyRiskScore={activity.policy_risk_score}
                            baseRiskScore={activity.risk_score}
                            riskFusionFormula={activity.risk_fusion_formula}
                            variant="detailed"
                          />
                        </div>
                      )}
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-4">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            {activity.policy_evaluated && activity.policy_risk_score !== null && (
                              <div className="pt-2 border-t border-gray-200">
                                <div className="flex justify-between items-center mb-1">
                                  <span className="text-gray-600">Policy Risk Score:</span>
                                  <span className="font-semibold text-purple-600">{activity.policy_risk_score} / 100</span>
                                </div>
                                <div className="w-full bg-gray-200 rounded-full h-2">
                                  <div
                                    className="h-2 rounded-full bg-purple-600 transition-all"
                                    style={{ width: `${Math.min(activity.policy_risk_score, 100)}%` }}
                                  />
                                </div>
                              </div>
                            )}
