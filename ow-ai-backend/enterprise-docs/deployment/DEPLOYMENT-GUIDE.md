...
CREATE USER owkai_app WITH REDACTED-CREDENTIAL 'AppUserPassword123!';
...
export DATABASE_URL="postgresql://owkai_admin:REDACTED-CREDENTIAL@owkai-pilot-db.cluster-xxx.us-east-1.rds.amazonaws.com:5432/owkai_pilot"
