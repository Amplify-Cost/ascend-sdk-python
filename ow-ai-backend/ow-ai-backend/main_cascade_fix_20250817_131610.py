...
from routes.analytics_routes_routes_routes import router as analytics_router
from routes.smart_alerts import router as smart_alerts_router
from routes.data_rights_routes_routes_routes import router as data_rights_router
#from routes.mcp_governance_routes import router as mcp_governance_router
from routes.unified_governance_routes_routes_routes import router as unified_governance_router
...
for router_name in ROUTER_NAMES:
    try:
        if router_name == "auth":
            ...
            from routes.analytics_routes_routes import router as analytics_router
            ...
            from routes.data_rights_routes_routes import router as data_rights_router
            ROUTE_MODULES[router_name] = data_rights_router
        elif router_name == "unified_governance":
            from routes.unified_governance_routes_routes import router as unified_governance_router
